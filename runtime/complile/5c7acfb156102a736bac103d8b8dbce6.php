...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		<form action="<?php echo \core\basic\Url::get('/admin/Link/mod');?>" method="post" class="layui-form" onkeydown="if(event.keyCode==13) return false;">
		   	 <input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	  		<table class="layui-table">
                ...
                <tbody>
                    <?php $num = 0;foreach ($this->getVar('links') as $key => $value) { $num++;?>
                    <tr>
                    	<td><?php echo $value->gid; ?></td>
                        <td><?php echo $value->name; ?></td>
                        <td><?php echo $value->link; ?></td>
                        <td><img src="<?php echo SITE_DIR;?><?php echo $value->logo; ?>" style="height:20px;"></td>
	  	...
	  	<div class="layui-tab-item">
	  		 <form action="<?php echo \core\basic\Url::get('/admin/Link/add');?>" method="post" class="layui-form">
	  		 	<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		 <form action="<?php echo \core\basic\Url::get('/admin/Link/mod/id/'.get('id').'');?><?php echo $this->getVar('backurl');?>" method="post" class="layui-form">
	  		 	<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 

                <div class="layui-form-item">
                     <label class="layui-form-label">分组</label>
                     <div class="layui-input-block">
                     	<input type="text" name="gid" required  lay-verify="required" value="<?php echo @$this->getVar('link')->gid;?>" placeholder="请输入分组"  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">名称</label>
                     <div class="layui-input-block">
                     	<input type="text" name="name" required  lay-verify="required" value="<?php echo @$this->getVar('link')->name;?>" placeholder="请输入名称"  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">链接</label>
                     <div class="layui-input-block">
                     	<input type="text" name="link" required  lay-verify="required" value="<?php echo @$this->getVar('link')->link;?>" placeholder="请输入链接"  class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">图片</label>
                     <div class="layui-input-inline">
                     	<input type="text" name="logo" id="logo" placeholder="请上传图片"  value="<?php echo @$this->getVar('link')->logo;?>" class="layui-input">
                     </div>
                     <button type="button" class="layui-btn upload" data-des="logo">
					 	 <i class="layui-icon">&#xe67c;</i>上传图片
					 </button>
					 <div id="logo_box" class="pic"><?php if ($this->getVar('link')->logo) {?><dl><dt><img src="<?php echo SITE_DIR;?><?php echo @$this->getVar('link')->logo;?>" data-url="<?php echo @$this->getVar('link')->logo;?>"></dt><dd>删除</dd></dl><?php } ?></div>
                </div>
                
                 <div class="layui-form-item">
                     <label class="layui-form-label">排序</label>
                     <div class="layui-input-block">
                     	<input type="text" name="sorting" required lay-verify="required" value="<?php echo @$this->getVar('link')->sorting;?>" placeholder="请输入排序"  class="layui-input">
                     </div>
                </div>
...
<?php return array (
  0 => 'E:/hz/apps/admin/view/default/common/head.html',
  1 => 'E:/hz/apps/admin/view/default/common/foot.html',
); ?>